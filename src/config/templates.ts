...
export const TEMPLATES: Template[] = [
  // ========== T1: 瑞士建筑 (Swiss Grid) — 3:4 Portrait Instagram ==========
  {
    ...
    layers: [
      ...
      { id: 'img1', type: 'image', content: './img/arch.jpg', x: 50, y: 62, scale: 0.75, rotate: 0, opacity: 1, borderRadius: 0, isLocked: false, isVisible: true } as Layer,
  ...
  // ========== T2: 时尚封面 (Luxe Cover) — 3:4 Portrait Instagram ==========
  {
    ...
    bg: '#0F0F0F',
    layers: [
      { id: 'img1', type: 'image', content: './img/luxe.jpg', x: 50, y: 50, scale: 1.2, rotate: 0, opacity: 0.7, borderRadius: 0, isLocked: false, isVisible: true } as Layer,
  ...
  // ========== T3: 赛博霓虹 (Neon Cyber) — 9:16 Story Instagram/TikTok ==========
  {
    ...
    bg: '#0A0A0A',
    layers: [
      { id: 'img1', type: 'image', content: './img/cyber.jpg', x: 50, y: 40, scale: 0.9, rotate: 0, opacity: 0.4, borderRadius: 0, grayscale: 80, isLocked: false, isVisible: true } as Layer,
  ...
  // ========== T4: 莫兰迪花艺 (Morandi Bloom) — 1:1 Square Instagram/Facebook ==========
  {
    ...
    bg: '#EDE8E0',
    layers: [
      { id: 'img1', type: 'image', content: './img/bloom.jpg', x: 50, y: 55, scale: 1.1, rotate: 0, opacity: 0.85, borderRadius: 24, grayscale: 20, isLocked: false, isVisible: true } as Layer,
  ...
  // ========== T6: 水墨意境 (Ink Wash) — 3:4 Portrait Instagram ==========
  {
    ...
    bg: '#F5F0E8',
    layers: [
      { id: 'img1', type: 'image', content: './img/ink.jpg', x: 50, y: 55, scale: 1.0, rotate: 0, opacity: 0.7, borderRadius: 0, grayscale: 40, isLocked: false, isVisible: true } as Layer,
  ...
  // ========== T7: 复古唱片 (Retro Vinyl) — 1:1 Square Instagram/Facebook ==========
  {
    ...
    bg: '#F2E6D4',
    layers: [
      { id: 'img1', type: 'image', content: './img/vinyl.jpg', x: 50, y: 48, scale: 0.85, rotate: 0, opacity: 1, borderRadius: 0, isLocked: false, isVisible: true } as Layer,
  ...
  // ========== T8: 科技发布会 (Tech Launch) — 9:16 Story IG/TikTok ==========
  {
    ...
    bg: '#000000',
    layers: [
      { id: 'img1', type: 'image', content: './img/tech.jpg', x: 50, y: 60, scale: 0.7, rotate: 0, opacity: 0.6, borderRadius: 20, isLocked: false, isVisible: true } as Layer,
